...
1. Choose a prompt from the files below
2. Use with your preferred AI art generator
3. Save generated images to `docs/images/`
...
- Storm, lightning, chaos imagery
- Modern, clean, professional

**Avoid**:
- Overly decorative or frivolous
- Bright/cheerful colors
- Cartoon style (keep it serious/professional)

---

## Image Specifications

**Logo**: 512x512px, transparent background, SVG preferred  
**Banner**: 1200x300px for GitHub header  
**Diagrams**: 1920x1080px, clear labels  
**Icons**: 64x64px, simple, monochrome-friendly
