...
Clean lines, suitable for software branding.
Transparent background, vector-style.
```

**Use for**: Main logo, favicon, GitHub avatar
...
Modern software branding style, minimalist.
Transparent background, 512x512px.
```

**Use for**: Alternative logo, loading screens
...
Technical, modern aesthetic suitable for developer tools.
Sharp, professional, not decorative.
```

**Use for**: Icon variations, app icon

---

## GitHub Repository Banner

### Prompt 4: Storm Over Code
...
**Use for**: GitHub repository header, documentation headers
...
Suitable for favicon, terminal output, CLI tools.
```

**Use for**: Favicon, CLI branding, small spaces
...
- Lightning Blue: #60a5fa
- Dark Background: #0f172a

**Accent Colors**:
- Chaos Red: #dc2626 (for errors/warnings)
